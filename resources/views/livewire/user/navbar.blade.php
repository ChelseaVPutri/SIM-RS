        ...
        <div class="flex items-center gap-4">
            <div class="group relative">
                ...
                <div class="absolute right-0 mt-2 w-56 origin-top-right scale-95 transform rounded-lg bg-white opacity-0 shadow-lg ring-opacity-5 transition-all duration-200 ease-in-out group-hover:scale-100 group-hover:opacity-100" role="menu">
                    <div class="py-1">
                        {{-- Dashboard --}}
                        <a href="{{ route('user-dashboard') }}" class="flex w-full items-center gap-3 px-4 py-2 text-sm text-[#111318] hover:bg-gray-100">
                        ...
                        {{-- Pengajuan Cuti --}}
                        <a href="{{ route('pengajuan-cuti') }}" class="flex w-full items-center gap-3 px-4 py-2 text-sm text-[#111318] hover:bg-gray-100">
                        ...
                        {{-- Keluar --}}
                        <a wire:click="logout" class="flex w-full items-center gap-3 px-4 py-2 text-sm text-red-500 hover:bg-gray-100 cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
